...
*********************************************************/
  ...
  if (!$resp->is_valid) {
    ...
    $query = "INSERT INTO abstracts VALUES ( '', '$date', '$title', '$author1', '$organization1', '$author2', '$organization2', '$author3', '$organization3', '$author4', '$organization4', '$author5', '$organization5', '$author6', '$organization6', '$author7', '$organization7', '$author8', '$organization8', '$author9', '$organization9', '$author10', '$organization10', '$format', '$language', '$presenter', '$background', '$purpose', '$methods', '$findings', '$conclusion', '$word_count', '$name', '$email1', '$email2', '$phone1', '$phone2', '$fax', '$address', '$topic', '$country', 'Unfiled', '', '' )";
    ...
    if ($author7)
        $body2 = $body2 . "\nAuthor 7: " . $author7 . "\nOrganization 7: " . $organization7;
    if ($author8)
        $body2 = $body2 . "\nAuthor 8: " . $author8 . "\nOrganization 8: " . $organization8;
    if ($author9)
        $body2 = $body2 . "\nAuthor 9: " . $author9 . "\nOrganization 9: " . $organization9;
    if ($author10)
        $body2 = $body2 . "\nAuthor 10: " . $author10 . "\nOrganization 10: " . $organization10;
    $body2 = $body2 . "\n\nPRESENTATION\nFormat: " . $format . "\nLanguage: " . $language . "\nPresenter: " . $presenter .
            "\n\nCONTENT\nTopic: " . $topic . "\nCountry: " . $country . "\n\nBackground: " . 
            $background . "\n\nPurpose: " . $purpose . "\n\nMethods: " .
